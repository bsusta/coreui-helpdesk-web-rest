import { SET_PROJECTS, SET_PROJECTS_LOADING, ADD_PROJECT, SET_PROJECT_LOADING, SET_PROJECT, EDIT_PROJECT } from '../types'
  ...
  switch (action.type) {
    ...
    case ADD_PROJECT:
      ...
      case SET_PROJECT_LOADING:
        return { ...state, projectLoaded:action.projectLoaded };
      case SET_PROJECT:
