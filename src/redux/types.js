...
//all constants for ATTACHEMENTS actions
export const ADD_ATTACHEMENT = 'ADD_ATTACHEMENT';
export const EDIT_ATTACHEMENT = 'EDIT_ATTACHEMENT';
...
//all constants for COMMENTS ATTACHEMENTS actions
export const SET_COMMENT_ATTACHEMENTS = 'SET_COMMENT_ATTACHEMENTS';
export const SET_COMMENT_ATTACHEMENT = 'SET_COMMENT_ATTACHEMENT';
export const ADD_COMMENT_ATTACHEMENT = 'ADD_COMMENT_ATTACHEMENT';
export const SET_COMMENT_ATTACHEMENTS_LOADING = 'SET_COMMENT_ATTACHEMENTS_LOADING';
export const DELETE_COMMENT_ATTACHEMENT = 'DELETE_COMMENT_ATTACHEMENT';
export const DELETE_COMMENT_ATTACHEMENTS = 'DELETE_COMMENT_ATTACHEMENTS';
