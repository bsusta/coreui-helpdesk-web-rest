...
class UnitEdit extends Component {
	...
	compareChanges(change, val) {
		...
		this.setState({
			changed:
				newState.title != this.props.unit.title ||
				newState.shortcut != this.props.unit.shortcut ||
				newState.active != this.props.unit.is_active,
		});
	}
				...
				<div className="card-body">
					<h2 className="h2" className="h2-setting-form">
						...
						>
							...
							<div className="form-group">
								<label className="input-label" htmlFor="shortcut" className="req input-label">
									{i18n.t('shortcut')}
								</label>
								<input
									className="form-control"
								...
								{this.state.submitError &&
									this.state.shortcut === '' && (
										<label className="input-label" htmlFor="shortcut" style={{ color: 'red' }}>
											{i18n.t('restrictionMustEnterShortcut')}
										</label>
									)}
							</div>
							<div className="form-group">
