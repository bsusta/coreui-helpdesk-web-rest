...
class CompanyAttributeEdit extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      newOption: "",
      options:
        (this.props.companyAttribute.type == "simple_select" ||
          this.props.companyAttribute.type == "multi_select") &&
...
export default connect(mapStateToProps, { editCompanyAttribute })(
  CompanyAttributeEdit
);
