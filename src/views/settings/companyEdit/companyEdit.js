          ...
          if(attribute[i]!==null){
            switch (i) {
              case 'dateValue':{
                ...
                company_data[attribute.companyAttribute.id]=date.toISOString().substring(0,date.toISOString().length-1);
                break;
              }
              case 'value':{
                let original = this.props.companyAttributes[this.props.companyAttributes.findIndex((item)=>item.id==attribute.companyAttribute.id)];
              ...
              case 'boolValue':
                company_data[attribute.companyAttribute.id]=attribute.boolValue;
                break;
              default:
                break;
            }
