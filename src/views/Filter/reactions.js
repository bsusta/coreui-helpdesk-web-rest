  ...
  componentWillMount(){
    ...
    if(this.props.match.params.projectID){
      ...
      if(this.props.match.params.tagID){
        tag=this.getFilterItem(this.props.match.params.tagID,this.props.tags);
        if(!tag){
          this.props.history.push('/404');
          return;
        }
      ...
      if(project && tag){
        ...
        this.props.getUsersFilter(this.props.taskAttributes,this.props.statuses,this.props.projects,this.props.users,this.props.tags,this.props.companies,null,this.props.match.params,this.props.order,this.props.token);
      }else if(project && !filter){
        console.log('load it');
  ...
  componentWillReceiveProps(props){
    ...
    //ak sa zmeni project, nacitaj ho
      ...
      if(props.match.params.tagID){
        tag=this.getFilterItem(props.match.params.tagID,this.props.tags);
        if(!tag){
          this.props.history.push('/404');
          return;
        }
      ...
      let filter = props.match.params.id!=='add'?props.match.params.id:undefined;
      console.log('change in project');
      if(project && tag){
        this.props.setFilterBody('tag='+props.match.params.tagID+'&project='+props.match.params.projectID,{tags:[tag], projects:[project]},1);
      }else if(project && filter){
        this.props.getFilter(this.props.taskAttributes,this.props.statuses,this.props.projects,this.props.users,this.props.tags,this.props.companies,props.match.params.id,this.props.history,project,this.props.token);
      }else if(!project && tag){
        this.props.setFilterBody('tag='+props.match.params.tagID,{tags:[tag]},1);
      }else if(!project && filter){
        this.props.getFilter(this.props.taskAttributes,this.props.statuses,this.props.projects,this.props.users,this.props.tags,this.props.companies,props.match.params.id,this.props.history,null,this.props.token);
      }else if(!project && !filter){
        this.props.getUsersFilter(this.props.taskAttributes,this.props.statuses,this.props.projects,this.props.users,this.props.tags,this.props.companies,null,this.props.match.params,this.props.order,this.props.token);
      }else if(project && !filter){
        this.props.getUsersFilter(this.props.taskAttributes,this.props.statuses,this.props.projects,this.props.users,this.props.tags,this.props.companies,project,this.props.match.params,this.props.order,this.props.token);
