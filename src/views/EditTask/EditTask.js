...
class EditTask extends Component {
  ...
  autoSubmit(name, value, id) {
    ...
    let task_data = processCustomAttributes({ ...state.task_data }, [
      ...this.props.taskAttributes
    ]);
    if (
      containsNullRequiredAttribute(task_data, [
        ...this.props.taskAttributes
      ]) ||
      state.title === "" ||
      state.requestedBy.id === undefined ||
          ...
          >
            ...
            {this.state.submitError && (
              <span>
                <h5 style={{ color: "red" }}>
                  {" "}
                  {i18n.t("restrictionTaskWontSave")}
                </h5>
              </span>
            )}
          </CardHeader>
            ...
            <div>
              <div className="row">
                ...
                <div className="col-4">
                  ...
                  <FormGroup>
                    <label htmlFor="requester" className="req">
                      {i18n.t("requester")}
                    </label>
                    <InputGroup
                      className={
                  ...
                  <FormGroup>
                    ...
                    <InputGroup
                      className={
                        this.state.company.id === undefined ? "fieldError" : ""
                      }
                    >
                      <InputGroupAddon>
                    ...
                    {this.state.company.id === undefined && (
                      <label htmlFor="title" style={{ color: "red" }}>
                        ...
                        return (
                          <div
                            className={
                              ...
                              (attribute.required &&
                              isNaN(
                                parseFloat(this.state.task_data[attribute.id])
                              )
                                ? " fieldError"
                                : "")
                            }
                            ...
                            {attribute.required &&
                              isNaN(
                                ...
                                <span>
                                  ...
                                  >
                                    {i18n.t(
                                      "restrictionFieldRequiredAndNotValid"
                                    )}
                                  </label>
                                </span>
                              )}
