		...
		return (
			<div className="fontRegular">
				...
				<Card>
					...
					<CardBody>
						<div className="row" style={{ borderBottom: '1px solid #eee', marginBottom: 17 }}>
							<div className="col-8">
						...
						<div>
							<div className="row">
								...
								<div className="col-4">
										...
										{this.props.task.closedAt &&
											this.state.status.toString() === '4' && (
												<span style={{ float: 'right' }}>
													{i18n.t('closedAt')}: {timestampToString(this.props.task.closedAt)}
												</span>
											)}
										<InputGroup>
											<InputGroupAddon>
									...
									<FormGroup>
										<label htmlFor="work_type" className="input-label">
											{i18n.t('work_type')}
										</label>
										<InputGroup>
											<InputGroupAddon>
